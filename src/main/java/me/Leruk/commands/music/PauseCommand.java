...
public class PauseCommand extends ListenerAdapter {
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent e) {
        ...
        if(args[0].equalsIgnoreCase(DiscordBot.getPrefix() + "pause"))
        {
            ...
            if (args.length > 1) {
                error.setDescription('`' + DiscordBot.getPrefix() + "pause` - команда для остановки бота");
            ...
            {
                error.setDescription("Ничего ставить на паузу");
            ...
            pause.setDescription(PAUSE + " Пауза");
